...
2.  **Downscaling:** Apply a spatio-temporal PyTorch Transformer that uses geographic embeddings (Latitude, Longitude, Elevation) and deep quantile regression to refine coarse data against historical ground-truth data.
